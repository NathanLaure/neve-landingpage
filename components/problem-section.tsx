export default function ProblemSection() {
  return (
    <section className="bg-gray-50/50 py-16 md:py-24 border-b border-gray-100 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 relative z-10">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {/* Card 1 */}
          <div className="relative p-7 rounded-3xl border border-gray-200/60 bg-white hover:border-emerald-250 shadow-xs hover:shadow-xl transition-all duration-300 group">
            <div className="w-12 h-12 rounded-xl bg-orange-50 text-[color:var(--color-brand-orange)] flex items-center justify-center mb-6 shadow-sm border border-orange-100/50 group-hover:scale-105 transition-transform duration-200">
              <svg className="w-6 h-6 stroke-current fill-none" viewBox="0 0 24 24" strokeWidth="2.5">
                <path strokeLinecap="round" strokeLinejoin="round" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" />
              </svg>
            </div>
            <h3 className="text-lg font-bold text-slate-900 mb-3 group-hover:text-[color:var(--color-brand-orange)] transition-colors">
          ...
          {/* Card 2 */}
          <div className="relative p-7 rounded-3xl border border-gray-200/60 bg-white hover:border-emerald-250 shadow-xs hover:shadow-xl transition-all duration-300 group">
            <div className="w-12 h-12 rounded-xl bg-emerald-50 text-[color:var(--color-brand-green)] flex items-center justify-center mb-6 shadow-sm border border-emerald-100/50 group-hover:scale-105 transition-transform duration-200">
              <svg className="w-6 h-6 stroke-current fill-none" viewBox="0 0 24 24" strokeWidth="2.5">
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
              </svg>
            </div>
            <h3 className="text-lg font-bold text-slate-900 mb-3 group-hover:text-[color:var(--color-brand-green)] transition-colors">
          ...
          {/* Card 3 */}
          <div className="relative p-7 rounded-3xl border border-gray-200/60 bg-white hover:border-emerald-250 shadow-xs hover:shadow-xl transition-all duration-300 group">
            <div className="w-12 h-12 rounded-xl bg-rose-50 text-rose-600 flex items-center justify-center mb-6 shadow-sm border border-rose-100/50 group-hover:scale-105 transition-transform duration-200">
              <svg className="w-6 h-6 stroke-current fill-none" viewBox="0 0 24 24" strokeWidth="2.5">
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
              </svg>
            </div>
            <h3 className="text-lg font-bold text-slate-900 mb-3 group-hover:text-rose-600 transition-colors">
