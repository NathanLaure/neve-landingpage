...
export default function Logo({ light = false }: { light?: boolean }) {
  return (
    <CustomLink href="/" variant="unstyled" className="inline-flex items-center gap-2" aria-label="Névé">
      ...
      <span className={`font-extrabold text-xl tracking-tight font-sans ${light ? "text-white" : "text-slate-900"}`}>
        Névé
      </span>
    </CustomLink>
  );
