...
export default function Logo() {
  return (
    <Link href="/" className="inline-flex items-center gap-2" aria-label="Névé">
      ...
      <span className="font-extrabold text-xl tracking-tight text-slate-900 font-sans">Névé</span>
    </Link>
  );
}
