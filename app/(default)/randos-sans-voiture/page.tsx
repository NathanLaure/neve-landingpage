...
export default function HubPage() {
  return (
    <div className="bg-white min-h-screen pt-24 md:pt-32">
      ...
      {/* Cities Grid */}
      <div className="mx-auto max-w-6xl px-4 sm:px-6 mb-24">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {CITIES.map((city) => (
            ...
            >
              ...
              <div className="relative z-10 mt-6 pt-4 border-t border-gray-100 flex items-center justify-between text-xs font-bold text-slate-900 group-hover:text-[color:var(--color-brand-orange)] transition duration-150">
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 mb-24">
